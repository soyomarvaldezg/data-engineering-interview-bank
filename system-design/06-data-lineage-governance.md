...
```xml
<!-- Ranger Policy: Block non-PII-processors from accessing emails -->
<policy>
  <name>protect-pii-emails</name>
  <resources>
    <resource>
      <type>database</type>
    ...
    <resource>
      <type>column</type>
      <value>email, phone, ssn</value> <!-- PII columns -->
    </resource>
  </resources>
  <policyItems>
    <policyItem>
      ...
      <users>pii-processor, compliance-officer</users>
      <effect>Allow</effect>
    </policyItem>
    <policyItem>
      <accesses>
...
```
# dbt genera metadata → Atlas ingests → Catalog updated
```

---

## Comparación: Soluciones de Governance

| Criterio          | Atlas (Open Source)                | Collibra (Comercial)   | Alation (Comercial)      |
| ----------------- | ---------------------------------- | ---------------------- | ------------------------ |
| **Costo**         | Gratis (infraestructura propia)    | $50-100k/año           | $50-100k/año             |
| **Setup**         | Complejo (infraestructura)         | Moderado (SaaS)        | Moderado (SaaS)          |
| **Integraciones** | Excelente (Hadoop ecosystem)       | Excelente (enterprise) | Excelente (BI focus)     |
| **UI/UX**         | Básica                             | Profesional            | Profesional              |
| **Auto-lineage**  | Sí (Spark, Hive)                   | Sí (conectores)        | Sí (conectores)          |
| **Collaboration** | Limitada                           | Excelente              | Excelente                |
| **Recomendación** | Empresas con equipo técnico fuerte | Empresas enterprise    | Empresas con focus en BI |
...
- **Error**: Ignorar cost-benefit → **Solución**: Balancear costo de platform vs riesgo de compliance

---

## Preguntas de Seguimiento

**"¿Cómo depuras si los datos cambian inesperadamente?"**

- Lineage: "¿Qué pipeline escribe esto?"
- Audit logs: "¿Quién/cuándo cambió?"
- Schema versioning: "¿Qué cambió en la estructura?"

**"¿Cómo manejas la dispersión de datos?"**

- Catalog: Descubrir todos los datasets
- Governance: Consolidar duplicados
- Lineage: Contra las fuentes de verdad

**"¿Cuál es el costo de una plataforma de metadatos?"**

- Platform: $10-50k/año (Alation, Collibra)
- En comparación con el esfuerzo manual: 100+ horas/año → desperdicio de dinero

**"¿Cómo adaptas la gobernanza según la industria?"**

- Finance: GDPR, PCI-DSS (estricto)
- Healthcare: HIPAA (muy estricto)
- E-commerce: GDPR (moderado)
...
- [Apache Ranger - Access Control](https://ranger.apache.org/)
- [GDPR Compliance - EU Regulation](https://gdpr.eu/)
- [Collibra Data Governance](https://www.collibra.com/us/en/products/data-governance)
