# Reading & Writing Data en PySpark

**Tags**: #pyspark #io #formats #parquet #csv #json #jdbc #real-interview  
**Empresas**: Amazon, Google, Databricks, Meta  
**Dificultad**: Mid  
...
- [DataFrameWriter - PySpark](https://spark.apache.org/docs/latest/api/python/reference/pyspark.sql/io.html)
