...
**Empresas**: Amazon, Google, Facebook, LinkedIn  
**Dificultad**: Senior  
...
- **Qué es**: Juntaruna tabla consigo misma usando aliases distintos. Permite encontrar relaciones dentro de los mismos datos
- **Por qué importa**: Jeraquías, reportes de línea, relaciones recursivas. Muy común en entrevistas. Demuestra comprensión profundo de JOINs
...
**Nota**: LEFT JOIN porque algunos (Alice, Frank) no tienen manager (son CEOs)
...
⚠️ **Nota**: `e1.id < e2.id` evita duplicados (Bob-Charlie vs Charlie-Bob)
