...
- **Qué es**: GROUP BY divide datos en grupos. HAVING filtra esos grupos basado en agregados. Funciones como SUM, COUNT, STRING_AGG combinan valores dentro de cada grupo
...
SELECT
  ...
  SUM(amount) as revenue_that_month
FROM sales
...
```
category | month | orders_that_month | revenue_that_month
